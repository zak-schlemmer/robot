...
# raise memory limit
RUN sed -i -e 's/memory_limit = 128M/memory_limit = 512M/g' /etc/php/7.0/apache2/php.ini

# add xdebug values to php.ini
COPY ./projects/custom/template/apache2/xdebug.php.ini /etc/php/7.0/apache2/conf.d/20-xdebug.ini
